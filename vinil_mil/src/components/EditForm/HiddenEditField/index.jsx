...
const HiddenEditField = ({children, name, value, handleChange}) => {
    ...
    return (
        <div className="edit-field-container">
            ...
            <input name={name} type={showPassword ? "text" : "password"} defaultValue={value} className='edit-field-text' onChange={handleChange} style={{width: '94%'}} placeholder={children} required/>
